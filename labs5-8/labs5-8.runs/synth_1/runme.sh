...
HD_PWD='C:/Users/rrine/VivadoProjects/labs5-8/labs5-8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU32Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU32Bit.tcl
