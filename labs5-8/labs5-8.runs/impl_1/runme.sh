...
HD_PWD='C:/Users/rrine/VivadoProjects/labs5-8/labs5-8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU32Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU32Bit.tcl -notrace
