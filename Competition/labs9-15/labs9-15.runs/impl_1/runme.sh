...
HD_PWD='C:/Users/rrine/VivadoProjects/ECE369AryDavidRusty/Competition/labs9-15/labs9-15.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopTopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopTopLevel.tcl -notrace
