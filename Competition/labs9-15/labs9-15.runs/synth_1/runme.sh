...
HD_PWD='C:/Users/rrine/VivadoProjects/ECE369AryDavidRusty/Competition/labs9-15/labs9-15.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopTopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopTopLevel.tcl
